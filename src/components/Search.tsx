    ...
    <div className="relative flex mr-4">
      {isVisible && (
        <input
          ...
          } -mr-3 z-30 p-2.5 text-sm font-medium text-customBlue dark:text-white bg-white hover:bg-gray-300 border-gray-700 focus:outline-none rounded-lg px-5 py-2.5 dark:bg-slate-800 dark:hover:bg-slate-600`}
